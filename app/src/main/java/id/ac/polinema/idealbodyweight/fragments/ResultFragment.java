    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tryAgainButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mListener != null && getTag() == "BrocaIndexFragment") {
                    mListener.onTryAgainButtonClicked("BrocaIndexFragment");
                }
                else{
                    mListener.onTryAgainButtonClicked("BodyMassIndexFragment");
                }
            }
        });
        return  view;
